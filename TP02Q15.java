...
public class TP02Q15 {
    ...
    private static void writeMatricula(long totalTime, int comparisons) {
        String OUTPUT_FILE_NAME = "matrícula_selecaoParcial.txt";
    ...
    public static void main(String[] args) {
        ...
        String[] topNomes = nome.findTopK(10); // Encontre os 10 menores registros
        long endTime = System.currentTimeMillis();

        long executionTime = endTime - startTime;
        totalTime += executionTime;

        for (int i = 0; i < topNomes.length; i++) {
            String nomeOrdenado = topNomes[i];
